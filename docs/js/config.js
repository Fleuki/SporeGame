...
export const CONFIG = {
  ...
  characters: {
    ...
    list: {
      ...
      //
      // 40 монет — примерно три забега неистраченного остатка. Дешевле нельзя:
      // персонаж, открывшийся с первого забега, ничего не значит. Дороже
      // тоже нельзя — цена, до которой не доходят, это то же ложное обещание,
      // только с ценником.
      ranger: {
        name:"Егерь", cost:40,
