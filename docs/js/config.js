...
export const CONFIG = {
  ...
  enemies: {
    ...
    touchPush: 2.4,
    // КОНТУР. Арена тёмная, земля нарисована мхом и грибами, а враги —
    // тёмные силуэты на тёмном фоне: пока их не подсветишь, «врагов в поле
    // зрения почти не видно». Тонкий светящийся контур рисуется ПОД спрайтом
    // на два пикселя шире — фигура отделяется от земли, оставаясь силуэтом.
    // 1.4, а не 2: при зуме 1.6 каждая мировая единица — это полтора пикселя
    // экрана, и двойка превращала контур в наклейку вокруг врага.
    rimWidth: 1.4, rimAlpha: 0.5,
    types: {
      spore_bearer: {
