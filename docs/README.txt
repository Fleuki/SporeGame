...
ПРОДОЛЖАЕШЬ РАБОТУ? Читай docs/HANDOFF.md — там состояние проекта,
очередь задач и грабли, на которых уже обожглись. Этот файл — только
про запуск и подключение своих картинок.
...
УПРАВЛЕНИЕ
============================================
  WASD / джойстик на экране — движение (на телефоне джойстик появляется
                             под пальцем в любой точке экрана)
