...
**У скрипта два режима, и выбирать их надо глазами.** Кеинг недоопределён:
...
Правило: есть в картинке кремовое, белое, бледное — `pale`, иначе обычный.
Проверять итог обязательно на ТЁМНОМ фоне: на светлом розовый подмес и
съеденная альфа не видны.
